...
def make_predictions(dataset, learning_rate=0.01, L1_reg=0.01, L2_reg=0.0001, n_epochs=10,
              batch_size=20, n_hidden=4,in_size=1,out_size=2,
...
def train_mlp(datasets,learning_rate=0.1, L1_reg=0.00, L2_reg=0.000, n_epochs=100,
             batch_size=50, n_hidden=4,in_size=1,out_size=2,
